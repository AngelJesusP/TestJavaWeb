 ...
 * 
 */
@WebServiceClient(name = "webService", targetNamespace = "http://webService.web.app/", wsdlLocation = "http://localhost:8080/webServiceServerEJB/webService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICE_QNAME = new QName("http://webService.web.app/", "webService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/webServiceServerEJB/webService?wsdl");
    ...
    public WebService getWebServicePort() {
        return super.getPort(new QName("http://webService.web.app/", "webServicePort"), WebService.class);
    }
    ...
    public WebService getWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webService.web.app/", "webServicePort"), WebService.class, features);
    }
